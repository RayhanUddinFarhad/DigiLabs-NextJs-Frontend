...
const Banner = () => {
    ...
    return (
        ...
        <div className="bg-[#2B63D9] relative">
            ...
            <section className="pt-10 mx-auto max-w-screen-2xl pb-12 px-4 items-center flex lg:flex-row flex-col-reverse  justify-center md:px-8">
                <div 
 className=" flex-1 sm:text-center lg:text-left">
 ...
 className='space-y-4'>
                 ...
                 <button
                    ...
                    <p className='text-white font-bold mb-4'>Who supports us</p>

<div className='grid lg:grid-cols-4 grid-cols-2'>

    <Image className='w-full' src="/assets/GitLab.png" width={112} height={28} alt=''></Image>
    <Image className='w-full' src="/assets/Slack.png" width={112} height={28} alt=''></Image>
    <Image className='w-full' src="/assets/Netflix.png" width={112} height={28} alt=''></Image>
    <Image className='w-full' src="/assets/paypal.png" width={112} height={28} alt=''></Image>
</div>
                    </div>
 ...
 className='mt-20'>
   ...
   data-aos-duration="1000" xmlns="http://www.w3.org/2000/svg" className='lg:w-[224px] w-[137px]'  viewBox="0 0 225 112" fill="none">
