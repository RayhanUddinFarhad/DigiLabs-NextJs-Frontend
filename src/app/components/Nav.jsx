...
const Nav = () => {
    ...
    const navigation = [
        ...
        { title: "Our Products", path: "javascript:void(0)", isDrapdown: false },
        { title: "Resources", path: "javascript:void(0)", isDrapdown: true, navs: dropdownNavs },

        { title: "Contacts", path: "javascript:void(0)", isDrapdown: false }
    ]
    ...
    return (
        <>
            <nav className={`relative z-20 bg-[#437EF7] w-full md:static md:text-sm md:border-none ${state ? "shadow-lg rounded-b-xl md:shadow-none" : ""}`}>
                <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
                    ...
                    <div className={`nav-menu flex-1 pb-3 mt-8 md:block md:pb-0 md:mt-0 ${state ? 'block' : 'hidden'}`}>
                        <ul className="items-center space-y-6 md:flex md:space-x-8 md:space-y-0 text-sm">
                            {
                                navigation.map((item, idx) => {
                                    return (
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    <button className="w-full flex items-center justify-between gap-1 text-white hover:text-indigo-600"
